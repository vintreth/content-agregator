...
<body>
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin6">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<c:url value="/resources/assets/images/users/1.jpg"/>" alt="user" class="rounded-circle" width="31"></a>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/admin/download/" aria-expanded="false">
    ...
    <!--chartis chart-->
    <script src="<c:url value="/resources/assets/libs/chartist/dist/chartist.min.js"/>"></script>
    <script src="<c:url value="/resources/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js"/>"></script>
